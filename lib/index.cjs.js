...
const ComboboxListOption = props => {
  ...
  const comboBoxContext = React__namespace.useContext(ComboBoxContext);
  const handleSelect = event => {
    comboBoxContext.handleSelect(dataItem, event);
  };
  return /*#__PURE__*/jsxRuntime.jsx(StyledComboboxOption, {
    focused: focused,
    selected: selected,
...
const ComboBoxListBox = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(StyledComboboxListBox, {
    "aria-live": open && "polite",
    children: mapDataItems(data, (item, idx) => {
      return /*#__PURE__*/jsxRuntime.jsx(ComboboxListOption, {
        dataItem: item,
...
const ComboBoxInput = props => {
  const [last, setLast] = React__namespace.useState(null);
  const comboBoxInputRef = React__namespace.useRef(null);
  const {
    onChange,
    onKeyDown,
    onKeyUp,
  ...
  return /*#__PURE__*/jsxRuntime.jsx(StyledComboboxInput, {
    onKeyDown: onKeyDown,
    onKeyUp: onKeyUp,
...
const Combobox = ({
  ...
  const [focusedItem, setFocusedItem] = React__namespace.useState(data[0]);
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ComboBoxContext.Provider, {
    value: {
      textField,
      valueField,
      handleSelect
    },
    children: /*#__PURE__*/jsxRuntime.jsxs(StyledComboboxWrapper, {
      ref: comboBoxRef,
      onClick: toggle,
      onFocus: onFocus,
      ...
      }), open && /*#__PURE__*/jsxRuntime.jsx(ComboBoxListBox, {
